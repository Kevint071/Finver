...
-- CreateEnum
CREATE TYPE "EventType" AS ENUM ('MOVEMENT_CREATED', 'MOVEMENT_EDITED', 'MOVEMENT_DELETED', 'CATEGORY_CREATED', 'CATEGORY_EDITED', 'CATEGORY_DEACTIVATED', 'ROLE_CHANGED', 'OWNERSHIP_TRANSFERRED');
...
-- AddForeignKey
ALTER TABLE "Movement" ADD CONSTRAINT "Movement_groupId_fkey" FOREIGN KEY ("groupId") REFERENCES "Group"("id") ON DELETE CASCADE ON UPDATE CASCADE;
